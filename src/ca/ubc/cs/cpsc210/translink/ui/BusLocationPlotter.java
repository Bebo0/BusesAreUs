...
public class BusLocationPlotter extends MapViewOverlay {
    ...
    public void plotBuses() {
        ...
        if (selected != null)
        {
            ...
            {
                OverlayItem oi = new OverlayItem(b.getRoute().getName(),
                        null, new GeoPoint(b.getLatLon().getLatitude(),
                        b.getLatLon().getLongitude()));

                oi.setMarker(context.getResources().getDrawable(R.drawable.bus));
