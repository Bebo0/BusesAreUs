...
public class HttpArrivalDataProvider extends AbstractHttpDataProvider {
    ...
    protected URL getURL() throws MalformedURLException {
        ...
        Integer routeNumber = stop.getNumber();
        String routeNumberString = Integer.toString(routeNumber);
        String url = "http://api.translink.ca/rttiapi/v1/stops/"+routeNumberString + "/estimates?apikey="+key;
